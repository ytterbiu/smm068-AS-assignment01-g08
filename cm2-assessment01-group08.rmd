...
We attempt to find portfolio weights $\mathbf{w}$ that minimise the portfolio variance while yielding the target mean return $E$,
...
\text{s.t.} &\quad \mathbf{A}^T \mathbf{w} \geq \mathbf{b_0} 
\end{align*}
$$
