...
_Point of note: The first two moments about the mean of asset one and asset two
(the mean and the variance) are the same._
...
[^utility-theory]: Described in more detail in the appendix (\S\@ref(apd-utility-theory)).
